 ...
 *
 */
public class CellController extends DefaultTableCellRenderer{
	...
	private ImageIcon iconoGuardar = new ImageIcon("resources/images/ico_guardar.png");
	private ImageIcon iconoBuscar = new ImageIcon("recursos/images/ico_buscar.png");
	 ...
	 * @param tipo
	 */
	public CellController(String tipo){
		this.tipo=tipo;
	}
